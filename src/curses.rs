...
impl Curses {
    pub fn new(colors: &ColorScheme) -> Self {
        ...
        nc::init_pair(
            Color::Active as i16,
            colors.active_fg as i16,
            colors.common_bg as i16,
        );
        nc::init_pair(
            Color::ActiveHi as i16,
            colors.active_fg as i16,
            colors.highlight_bg as i16,
        );
        nc::init_pair(
            Color::Passive as i16,
            colors.passive_fg as i16,
            colors.common_bg as i16,
        );
        nc::init_pair(
            Color::PassiveHi as i16,
            colors.passive_fg as i16,
            colors.highlight_bg as i16,
        );
        nc::init_pair(
            Color::Changed as i16,
            colors.modified_fg as i16,
            colors.common_bg as i16,
        );
        nc::init_pair(
            Color::ChangedHi as i16,
            colors.modified_fg as i16,
            colors.highlight_bg as i16,
        );
        nc::init_pair(
            Color::StatusBar as i16,
            colors.statusbar_fg as i16,
            colors.statusbar_bg as i16,
        );
        nc::init_pair(
            Color::KeyBarId as i16,
            colors.keybarid_fg as i16,
            colors.keybarid_bg as i16,
        );
        nc::init_pair(
            Color::KeyBarTitle as i16,
            colors.keybartitle_fg as i16,
            colors.keybartitle_bg as i16,
        );
        nc::init_pair(
            Color::DialogNormal as i16,
            colors.dialog_fg as i16,
            colors.dialog_bg as i16,
        );
        nc::init_pair(
            Color::DialogShadow as i16,
            colors.shadow_fg as i16,
            colors.shadow_bg as i16,
        );
        nc::init_pair(
            Color::Button as i16,
            colors.button_fg as i16,
            colors.button_bg as i16,
        );
        nc::init_pair(
            Color::ButtonFocused as i16,
            colors.buttonfocused_fg as i16,
            colors.buttonfocused_bg as i16,
        );
        nc::init_pair(
            Color::ButtonDisabled as i16,
            colors.button_disabled_fg as i16,
            colors.dialog_bg as i16,
        );
        nc::init_pair(
            Color::Edit as i16,
            colors.edit_fg as i16,
            colors.edit_bg as i16,
        );
        nc::init_pair(
            Color::EditFocused as i16,
            colors.editfocused_fg as i16,
            colors.edit_bg as i16,
        );

        nc::wbkgdset(wnd, nc::COLOR_PAIR(Color::Active as i16));
