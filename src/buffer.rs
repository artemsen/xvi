...
#[derive(Copy, Clone)]
pub struct Change {
    pub offset: u64, // value offset
    pub old: u8,     // previous value
    pub new: u8,     // new value
}

/// Buffer of changes with undo/redo support
pub struct Buffer {
    queue: Vec<Change>, // changes queue
    index: usize,       // undo/redo position (index of the next change)
}
